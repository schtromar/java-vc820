...
public class Segment
{
    ...
    */
    ...
    public int convert(){
            if(this.toByte()==0b01111101){
                return 0;
            }
            else if(this.toByte()==0b00000101){
                return 1;
            }
            else if(this.toByte()==0b01011011){
                return 2;
            }
            else if(this.toByte()==0b00011111){
                return 3;
            }
            else if(this.toByte()==0b00100111){
                return 4;
            }
            else if(this.toByte()==0b00111110){
                return 5;
            }
            else if(this.toByte()==0b01111110){
                return 6;
            }
            else if(this.toByte()==0b00010101){
                return 7;
            }
            else if(this.toByte()==0b01111111){
                return 8;
            }
            else if(this.toByte()==0b00111111){
                return 9;
            }
            else if(this.toByte()==0b01101000){
                return -2;
            }
            else{
                return -1;
