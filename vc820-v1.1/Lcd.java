...
public class Lcd
{
    ...
    public String toString(){
        ...
        //return "An error occured. If you're seeing his program was written by an incoptetent human being.";
    }
    
    
    public String getFlags(){
        String out = "";             //DO NOT USE SWITCH! MUST CHECK ALL SEGMENTS
        if(this.auto){
            out = out + " AUTO "; 
        }
        if (this.rs232){
    ...
    public String getPrefix(){
        if(this.micro){                  //DO NOT USE SWITCH! MUST CHECK ALL SEGMENTS
            return "μ" + acDc();
        } else if(this.nano){
            return "n";
        } else if(this.kilo){
    ...
    public String getBaseUnits(){
        if(this.volts){                      //DO NOT USE SWITCH! MUST CHECK ALL SEGMENTS
            return "V" + acDc();
        } else if(this.amps){
            return "A";
        } else if(this.farads){
    ...
    public float toFloat(){
        ...
        if(this.one.getDot()){               //DO NOT USE SWITCH! MUST CHECK ALL SEGMENTS
            value = value/1000;
